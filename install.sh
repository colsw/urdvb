...
rootfolder="/tmp/" #all files we be stored in /dvb-build/ subdirectory, use absolute path
mksquashfs_download="https://github.com/colsw/urdvb/raw/master/mksquashfs" #change this if you'd like
...
libelec_download="${libelec_download}/${libelec_version}.tar.gz"
...
echo "Downloading required files (this might take some time)..."
